    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
              ...
              Positioned(
                  ...
                  child: ClipRRect(
                      ...
                      child: Image(
                        ...
                        width: 130.0,
                        image:
                            NetworkImage(widget._list[widget.index].thumbnail),
                        fit: BoxFit.cover,
                      ))),
              Positioned(
                right: 20,
          ...
          Text('${widget._list[widget.index].description}'),
          SizedBox(
            height: 15,
          ),
          Text('Directors: ${widget._list[widget.index].directors}'),
          SizedBox(
            height: 15,
          ),
          Text('Genres: ${widget._list[widget.index].genres}'),
          Container(
            height: 130,
            //color: Colors.blue,
            // color: Colors.blue,
